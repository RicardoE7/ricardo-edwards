      ...
      <div className="relative z-10 flex h-full flex-col">
        ...
        <div className="mt-16 grid flex-1 items-end gap-10 lg:grid-cols-[.78fr_1.22fr]">
          <div className="max-w-md">
            ...
            <p className="mt-5 text-sm leading-6 text-white/45 sm:text-base">A full-stack AI-powered anime discovery platform that learns from user preferences, ratings, and watch history to deliver personalized recommendations and make finding your next great show effortless.</p>
          ...
          <motion.div whileHover={{ y: -4 }} transition={{ duration: .35 }} className="relative mx-auto w-full max-w-xl overflow-hidden rounded-[1.6rem] border border-white/[.1] bg-black/60 p-3 shadow-2xl shadow-black/40">
            <div className="overflow-hidden rounded-[1.2rem] border border-white/[.07] bg-[#111216]">
              ...
              <img
                src={omnime}
                alt="Omnime anime discovery interface with recommendations, watchlist, and genre filters"
